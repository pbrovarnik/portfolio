		...
		<section id="about">
			<Container>
				...
				<Row className="about-wrapper">
					<Col md={6} sm={12}>
						<Fade direction={isMobile ? '' : 'up'} duration={isMobile ? 1700 : 1000} delay={600} triggerOnce>
							<div className="about-wrapper__image-container">
								<ImageLoader className="rounded shadow-lg about-wrapper__image" alt="about" src={img} height={'3088'} width={'2320'} />
							</div>
						</Fade>
					</Col>
					<Col md={6} sm={12}>
						<Fade duration={1000} delay={1000} triggerOnce>
							<div className="about-wrapper__info">
								...
								<span className="d-flex mt-3 about-wrapper__info-btn">
									<a target="_blank" rel="noopener noreferrer" className={`cta-btn ${isMobile ? 'cta-btn--resume-mobile' : 'cta-btn--resume'}`} href={resume}>
										Resume
									</a>
									<Link
										...
										className={`cta-btn ${isMobile ? 'text-color-white--mobile' : 'text-color-white '}`}>
										View Projects
									</Link>
								</span>
							</div>
